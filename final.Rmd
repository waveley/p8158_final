...
## regression of resilienceand athlete identity
```{r}
x = sum(athletes$bounce, athletes$strs_evnt, athletes$strs_rcvr, athletes$snap_back, athletes$difficult,athletes$setbacks)
```
