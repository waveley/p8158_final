...
## Construct Reliability: Dedication to Sport

```{r}
dedication_to_sport <- c("cnsdr_ath", "sprt_goals", "frnds_ath", "think_sprt", "sprt_lvl")
...
habits <- c("smoking", "fruit_veg", "hr_sleep", "play_hrs")
selected_habits <- athletes[, habits] %>% map_df(., as.numeric)
habit_alpha <-  psych::alpha(selected_habits %>% as.matrix())
habit_alpha
athletes$fruit_veg
```
