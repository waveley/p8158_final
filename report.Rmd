...
The Athletic Identity Scale$^{[3]}$ (Appendix 3) includes 6 items and respondents are asked to report their degree of agreement to the prompt on a 7-point Likert scale (responses ranging from "strongly disagree" to "strongly agree"). The variables in this scale were hypothesized to be reflective of the latent construct athletic identity, which was the measure that we were primarily interested in.
