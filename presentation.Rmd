...
```{r}
aims <- c("sprt_goals", "cnsdr_ath", "frnds_ath", "sprt_impt", "think_sprt", "dprs_sprt", "bad_sprt", "athlete_yn")

num_ath <- dataset[,aims] %>% map_df(., as.numeric)
```

```{r}
gtsummary::tbl_summary(num_ath, by = "athlete_yn")
```
...
=======
Therefore, we conclude that there is **no** significant relationship between athletic identity and overall well-being.
>>>>>>> 3414997802c77f3960df8f639758ca212e07449c
...
=======
We found that estimated effect between athletic identity and resilience is negative, indicating that stronger athletic identity decreases resilience. Such effect is not significant. 
>>>>>>> 3414997802c77f3960df8f639758ca212e07449c
...
Resilience appeared to be significantly related to overall well-being for both athletes and non-athletes.
...
We were unable to use healthy lifestyle as a reflective latent variable. 
- Consider constructing formative latent variable
- Collect more data measuring this variable 
