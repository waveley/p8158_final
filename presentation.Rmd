...
- Smoking Status
Smoking status is measured on a likert-scale of 1-7, with larger number representing a higher smoking frequency. The histogram shows that non-athletes generally have higher frequencies of smoking than athletes across the entire range of smoking status.
